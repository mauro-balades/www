...
Types of unary operators: `unary minus(-)`, `increment(++)`, `decrement(--)`, `NOT(!)`, `Addressof operator(&)` and `sizeof()`.
...
Operator overloading is a great feature about modern programming languages and once you master it, it can make your c++ code much more readable and intuitive.
